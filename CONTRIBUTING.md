...
Report all issues through GitHub Issues using the [Report a Bug](https://github.com/gitwonk/gitwonk/issues/new?template=Bug_report.md) template.
...
File your feature request through GitHub Issues using the [Feature Request template](https://github.com/gitwonk/gitwonk/issues/new?template=Feature_request.md).
...
By contributing to GitWonk, you agree that your contributions will be licensed under its license specified in the repository you are contributing to.